...
\begin{frame}{Equivalence Relations}
  \begin{sqt:definition}[Definition: equivalence relation]
    A counting question may specify what it means for two configurations to be considered equal.
  \end{sqt:definition}

  \begin{sqt:result}[Result: configurations vs unique configurations]
    Stuff
  \end{sqt:result}

  \begin{sqt:tip}[Definition: equivalence class]
    stuff
  \end{sqt:tip}
\end{frame}
