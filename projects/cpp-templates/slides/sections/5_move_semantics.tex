...
\begin{frame}[fragile]{Copy Construction/Assignment}
  ...
  Copy constructors/assignments are typically implemented as deep copies. Meaning, a new area of memory is typically allocated, and corresponding
...
\begin{frame}[fragile]{Issue 1: Unnecessary Copies}
  ...
  \emph{(Assume for the sake of this example that copy elission has been turned off, and the gadget class does not have
  a move constructor.)}
  \begin{minted}{cpp}
  gadget makeGadget() {
    gadget temp{1000};
